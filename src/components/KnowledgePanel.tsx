  ...
  return <div className="bg-white border border-gray-200 rounded-lg shadow-sm h-full overflow-hidden flex flex-col">
      <div className="p-3 border-b border-gray-200">
        <div className="flex justify-between items-center">
          ...
          <button onClick={() => setShowOwnerFilter(!showOwnerFilter)} className="p-1.5 rounded-md text-gray-500 hover:text-gray-700 hover:bg-gray-100 touch-manipulation" title="Filter by team member" aria-label="Filter by team member">
            <Filter size={16} />
          </button>
        </div>
